...
public class HighLow extends Activity implements OnClickListener {
	...
	/**
	 * Since this activity is listening for click events on both buttons, the view object is used to determine if it was the new game button, which resets the local variables.
	 * 
	 * @param v
	 *            View object that generated this event.
	 */
